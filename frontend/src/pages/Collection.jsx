...
function Collection() {
  ...
  //  The below code will work only when we have not created fillet function and set it to setFillterProduct
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
            <Title text1={'ALL'} text2={'COLLECTIONS'} />   
                ...
                <select onChange={(e)=>setSortType(e.target.value)} className='border-2 border-gray-300 text-sm px-2 mt-1'>
